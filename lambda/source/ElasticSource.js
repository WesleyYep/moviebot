...
var getMoviesByPlot = function(plot) {
    // encode the plot
    ...
    return new Promise((resolve, reject) => {
        ...
        var req = postEsRequestBuilder(body);
...
var getMoviesByActorPlot = function(actor, plot) {
    console.log("calling elastic search for plot and actor")
...
function postEsRequestBuilder(body) {
...
module.exports = {
    getMoviesByPlot: getMoviesByPlot
};